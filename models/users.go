...
type User struct {
	...
	EncryptedPassword null.String `boil:"encrypted_password" json:"encrypted_password,omitempty" toml:"encrypted_password" yaml:"encrypted_password,omitempty"`
	EncryptedSalt     null.String `boil:"encrypted_salt" json:"encrypted_salt,omitempty" toml:"encrypted_salt" yaml:"encrypted_salt,omitempty"`
	PasswordResetAt   null.Time   `boil:"password_reset_at" json:"password_reset_at,omitempty" toml:"password_reset_at" yaml:"password_reset_at,omitempty"`
	ConfirmedAt       null.Time   `boil:"confirmed_at" json:"confirmed_at,omitempty" toml:"confirmed_at" yaml:"confirmed_at,omitempty"`
	Prefs             null.JSON   `boil:"prefs" json:"prefs,omitempty" toml:"prefs" yaml:"prefs,omitempty"`
...
var (
	userColumns               = []string{"id", "created_at", "updated_at", "updated_by", "enabled", "role", "username", "email_address", "first_name", "last_name", "summary", "encrypted_password", "encrypted_salt", "password_reset_at", "confirmed_at", "prefs"}
	userColumnsWithoutDefault = []string{"created_at", "updated_at", "updated_by", "enabled", "role", "username", "email_address", "first_name", "last_name", "summary", "encrypted_password", "encrypted_salt", "password_reset_at", "confirmed_at", "prefs"}
