...
type Event struct {
	...
	EventTime     string            `boil:"event_time" json:"event_time" toml:"event_time" yaml:"event_time"`
	EventLocation null.String       `boil:"event_location" json:"event_location,omitempty" toml:"event_location" yaml:"event_location,omitempty"`
	...
	ContactURL    null.String       `boil:"contact_url" json:"contact_url,omitempty" toml:"contact_url" yaml:"contact_url,omitempty"`
...
var (
	eventColumns               = []string{"id", "created_at", "updated_at", "updated_by", "published", "title", "slug", "summary", "body", "event_date", "event_time", "event_location", "contact_person", "contact_phone", "contact_email", "contact_url", "categories"}
	eventColumnsWithoutDefault = []string{"created_at", "updated_at", "updated_by", "published", "title", "slug", "summary", "body", "event_date", "event_time", "event_location", "contact_person", "contact_phone", "contact_email", "contact_url", "categories"}
...
func (o *Event) Insert(exec boil.Executor, whitelist ...string) error {
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO \"events\" DEFAULT VALUES"
		}
...
func (o *Event) UpsertG(updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	return o.Upsert(boil.GetDB(), updateOnConflict, conflictColumns, updateColumns, whitelist...)
}

// UpsertGP attempts an insert, and does an update or ignore on conflict. Panics on error.
func (o *Event) UpsertGP(updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) {
...
func (o *Event) UpsertP(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) {
...
func (o *Event) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns []string, whitelist ...string) error {
	if o == nil {
	...
	if !cached {
		...
		cache.query = queries.BuildUpsertQueryPostgres(dialect, "\"events\"", updateOnConflict, ret, update, conflict, insert)
